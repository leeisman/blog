                        ...
                        <div id="application" class="emp_box">
                            ...
                            <h3>
                                <div class="page-header content-title">
                                    ...
                                    <h2 class="font-welcome-title"><span >應用領域</span></h2>
                        ...
                        <div id="service-introduce" class="emp_box">
                            ...
                            <h3>
                                <div class="page-header content-title">
                                    ...
                                    <h2 class="font-welcome-title"><span >服務介紹</span></h2>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <i class="fa fa-battery-full margin-bottom-s" style="color:green">
                                            <a href="" class="span-middle font-s">鋰離子電池組</a>
                                        </i>
                                    </div>
                                    <div class="col-md-12">
                                        <i class="fa fa-battery-full margin-bottom-s" style="color:green">
                                            <a href="" class="span-middle font-s">鋰聚合物電池組</a>
                                        </i>
                                    </div>

                                    <div class="col-md-12">
                                        <i class="fa fa-battery-full margin-bottom-s" style="color:green">
                                            <a href="" class="span-middle font-s"> 鎳氫/鎳鎘電池組</a>
                                        </i>
                                    </div>

                                    <div class="col-md-12">
                                        <i class="fa fa-battery-full margin-bottom-s" style="color:green">
                                            <a href="" class="span-middle font-s">磷酸鋰鐵電池組</a>
                                        </i>
                                    </div>

                                    <div class="col-md-12">
                                        <i class="fa fa-battery-full margin-bottom-s" style="color:green">
                                            <a href="" class="span-middle font-s">鈕扣型電池組</a>
                                        </i>
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="certificate" class="emp_box">
                            ...
                            <h3>
                                <div class="page-header content-title">
                                    <h2 class="font-welcome-title"><span >認證服務</span></h2>
                                </div>
                            </h3>
